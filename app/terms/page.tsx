...
export default function TermsPage() {
  return <LegalPage title="Terms of Use">
    ...
    <section><h2>Premium access</h2><p>The current price and access period are shown in the Premium purchase dialog and confirmed again by PayMongo before payment. A successful one-time purchase grants the displayed access period and does not automatically renew. Payments are confirmed by PayMongo before access activates. Statutory consumer rights remain unaffected.</p></section>
